...
import { getEmbeddedPostgresTestSupport, startTestDatabase } from "./helpers/embedded-postgres.js";
...
describeEmbeddedPostgres("heartbeat comment wake batching", () => {
  ...
  beforeAll(async () => {
    tempDb = await startTestDatabase("paperclip-heartbeat-comment-wake-");
